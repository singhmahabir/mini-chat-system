...
<%
	HttpSession session1=request.getSession(false);
		...
		response.sendRedirect("index.htmlresponse.sendRedirect("index.html");
		mypack.Client ob=(mypack.Client)session.getAttribute("clientob");
%>
<head>
...
<body  background="image/1.jpg" topmargin="30" leftmargin="100" >
	...
	<center>
	<center><font color="red" size="3">previous user Name and new user name not be same</font></center><br>
		...
		<br><br>
		<input type="submit" value="submit"/><input type="reset" value=<%=ob.getUname()%>  name="s"  value="Reset" />
		</form><br>
